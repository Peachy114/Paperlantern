...
@section('content')
    <p style="margin:0 0 16px 0; color:#334155; font-size:15px; line-height:1.7;">
        Hi {{ $recipientName ?? 'wanderer' }},
    </p>

    <p style="margin:0 0 14px 0; color:#334155; font-size:15px; line-height:1.7;">
        Welcome to LaternComix. Your account is ready, and you can discover stories, follow creators, save favorites, comment, collect stickers, and support artists.
    </p>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:22px 0; background:#f8fafc; border:1px solid #e2e8f0; border-radius:16px;">
        <tr>
            <td style="padding:18px;">
                <p style="margin:0 0 10px 0; color:#0f172a; font-size:14px; font-weight:900;">Things to explore:</p>
                <p style="margin:0; color:#475569; font-size:14px; line-height:1.8;">
                    Browse comix, novels, arts, commissions, and shop items<br>
                    Follow creators and receive new release notifications<br>
                    Comment, like, favorite, and use stickers<br>
