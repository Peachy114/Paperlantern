...
class WorkController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'content_rating_assessment' => ['required', 'array'],
            'content_rating_assessment.violence' => ['required', 'integer', 'between:0,3'],
            'content_rating_assessment.sexual_content' => ['required', 'integer', 'between:0,3'],
            'content_rating_assessment.nudity' => ['required', 'integer', 'between:0,3'],
            'content_rating_assessment.profanity' => ['required', 'integer', 'between:0,3'],
            'content_rating_assessment.substances' => ['required', 'integer', 'between:0,3'],
            'content_rating_assessment.sensitivities' => ['nullable', 'array'],
            'content_rating_assessment.sensitivities.*' => ['string', 'max:80'],
            'content_rating_agreement' => ['accepted'],
    ...
    public function update(Request $request, Work $work): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'genres.*'        => ['string', 'max:50'],
            'content_rating_assessment' => ['sometimes', 'array'],
            'content_rating_assessment.violence' => ['required_with:content_rating_assessment', 'integer', 'between:0,3'],
            'content_rating_assessment.sexual_content' => ['required_with:content_rating_assessment', 'integer', 'between:0,3'],
            'content_rating_assessment.nudity' => ['required_with:content_rating_assessment', 'integer', 'between:0,3'],
            'content_rating_assessment.profanity' => ['required_with:content_rating_assessment', 'integer', 'between:0,3'],
            'content_rating_assessment.substances' => ['required_with:content_rating_assessment', 'integer', 'between:0,3'],
            'content_rating_assessment.sensitivities' => ['nullable', 'array'],
            'content_rating_assessment.sensitivities.*' => ['string', 'max:80'],
