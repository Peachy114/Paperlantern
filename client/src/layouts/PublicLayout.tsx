...
export default function PublicLayout() {
    return (
        <>
            ...
            <div className="relative min-h-screen flex flex-col bg-[#fffdf5] dark:bg-[#1a1712]">
                {/* ── Background layers ── */}
                ...
                <div
                    ...
                    style={{
                        backgroundImage:
                            'radial-gradient(circle, rgba(0,0,0,0.055) 1.2px, transparent 1.2px)',
                ...
                <div
                    ...
                    style={{
                        backgroundImage:
                            'radial-gradient(circle, rgba(180,160,120,0.04) 1.2px, transparent 1.2px)',
                        backgroundSize: '10px 10px',
                    }}
                />
