    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg,#f59e0b 0%,#ec4899 30%,#f59e0b 60%,#14b8a6 100%)' }}
        />
        ...
        <div className="relative z-10 px-6 pt-6">
          ...
          >
            ...
            <div className="text-[12px] text-[#6b7280] font-semibold mt-0.5 tracking-[0.04em]">
              {view === 'login' ? 'LOG IN TO CONTINUE READING.' : 'CREATE YOUR ACCOUNT AND START EXPLORING.'}
            </div>
          </div>
          ...
          >
            <button
              onClick={openLogin}
              className="flex-1 py-2 text-[14px] tracking-[0.1em] cursor-pointer transition-all duration-150 border-r border-[#1a1a1a]"
              style={{
                fontFamily: "'Bebas Neue', sans-serif",
                background: view === 'login' ? '#1a1a1a' : '#fffdf5',
                color: view === 'login' ? '#f59e0b' : '#6b7280',
              }}
            >
              LOGIN
            </button>
            <button
              ...
              className="flex-1 py-2 text-[14px] tracking-[0.1em] cursor-pointer transition-all duration-150"
              style={{
                fontFamily: "'Bebas Neue', sans-serif",
                background: view === 'register' ? '#1a1a1a' : '#fffdf5',
                color: view === 'register' ? '#f59e0b' : '#6b7280',
              }}
            >
              REGISTER
            </button>
