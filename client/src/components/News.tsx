            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {storageUrl(pinned.image) && (
                  <div className="w-full h-90 sm:w-48 sm:h-auto shrink-0 border-b-[2px] sm:border-b-0 sm:border-r-[2px] border-[#1a1a1a] dark:border-foreground/20 overflow-hidden">
                    <img
                ...
                <div className="flex-1 relative">
                  ...
                  <div className="relative z-10 pl-4 sm:pl-16 pr-4 sm:pr-6 py-6 sm:py-8">
                    ...
                    <div
                      ...
                      style={{
                        background: pinned.tag === 'event' ? '#86efac' : pinned.tag === 'reminder' ? '#fca5a5' : '#fef08a',
                    ...
                    >
                      {pinned.tag === 'event' ? '🎉 event' : pinned.tag === 'reminder' ? '🔔 reminder' : '📢 update'}
                    </div>
                    ...
                    <p
                      ...
                      style={{ fontFamily: "'Noto Serif', serif", fontSize: 'clamp(12px, 3vw, 14px)' }}
                    >
                      {pinned.content}
                    </p>
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 pt-3 sm:pt-4 border-t border-foreground/10">
                      <div
                        ...
                        style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '10px', letterSpacing: '0.2em' }}
                      >
                        {pinned.creator?.name?.toUpperCase() ?? 'STAFF'}
                      </div>
                      <span
                        className="text-muted-foreground"
                        style={{ fontFamily: "'Kalam', cursive", fontSize: 'clamp(10px, 2.5vw, 12px)' }}
                      >
                        Paper Lantern Editorial · {new Date(pinned.created_at).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
                      </span>
                    </div>
