    ...
    return (
        <div className="relative min-h-[82vh] flex flex-col items-center justify-center overflow-hidden bg-[#fffdf5] dark:bg-[#1a1712] px-4">
            ...
            >
                ...
                {/* Issue tag — top right */}
                <div
                    className="absolute -top-[13px] right-5 bg-[#F09595] border-2 border-foreground px-3 py-0.5"
                ...
                <div className="px-8 pt-12 pb-10 text-center flex flex-col items-center gap-6">
                    ...
                    <div className="flex items-center gap-3 w-full justify-center">
                        ...
                        <span className="text-[11px] tracking-[0.24em] text-[#F09595] font-bebas">
                            ✦ WHOOPS — NOTHING HERE ✦
                        </span>
                        <div className="flex-1 h-[2px] bg-foreground/15" />
                    </div>
                    ...
                    <div className="relative select-none">
                        {/* Shadow layer */}
                        <div className="absolute top-[6px] left-[6px] text-[88px] sm:text-[110px] leading-[0.88] tracking-[0.02em] text-foreground/10 pointer-events-none font-bebas">
                            PAGE
                            <br />
                            NOT FOUND
                        </div>
                        ...
                        >
                            ...
                            <p className="text-[13px] sm:text-[14px] tracking-[0.08em] text-foreground dark:text-[#e8dfc8] leading-snug font-bebas">
                                ...
                                <span className="text-amber-600 dark:text-amber-400">
                                    Head back and find a new story.
                                </span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3 mt-1">
                        <a
                            href="/"
                            className="px-4 py-1.5 border-2 border-foreground bg-foreground text-background text-[12px] tracking-[0.14em] hover:opacity-80 transition-opacity font-bebas"
                            style={{
                        ...
                        <a
                            href="/comics"
                            className="px-4 py-1.5 border-2 border-foreground text-foreground text-[12px] tracking-[0.14em] bg-transparent hover:bg-foreground/5 transition-colors font-bebas"
                            style={{
                                boxShadow: '3px 3px 0 var(--foreground)',
                            }}
                        >
