...
export default function UnlockModal({
  ...
  chapterTitle, creditsRequired, userBalance, unlocking
}: Props) {
              ...
              {canAfford ? (
                <>
                  <div className="flex items-center justify-between mb-4 pb-4 border-b-[2px] border-[#1a1a1a]/10 dark:border-foreground/10">
                    <span className="text-[#1a1a1a]/60 dark:text-foreground/60 text-small" style={{ fontFamily: "'Kalam', cursive" }}>
                      Cost
                    </span>
                    <span
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '0.1em', boxShadow: '2px 2px 0 #1a1a1a' }}
                    >
                ...
                <>
                  <div className="text-center py-2 mb-4">
                    ...
                    <p className="text-[#1a1a1a]/60 dark:text-foreground/50 text-small" style={{ fontFamily: "'Kalam', cursive" }}>
                      needed to unlock
                    </p>
                  </div>

                  <div
                    className="flex items-center justify-between px-3 py-2 mb-5 bg-red-50 dark:bg-red-950/30 border-[2px] border-red-200 dark:border-red-800"
                  >
                    <span className="text-red-500 text-small" style={{ fontFamily: "'Kalam', cursive" }}>
                      you're short
                    </span>
                    <span
