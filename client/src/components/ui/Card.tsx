...
export default function Card({
    ...
    const handleClick = onClick ?? (() => navigate(`/comics/${slug ?? id}`))
    ...
    return (
        <div onClick={handleClick} className="cursor-pointer group">
            ...
            <div className="mt-2">
                <div className="text-small font-semibold leading-snug text-foreground line-clamp-2">
                    {title}
                </div>
                {chapter ? (
                    <div className="text-xsmall text-muted-foreground mt-0.5 line-clamp-1">
