                          ...
                          border-[2.5px] border-foreground dark:border-[#3a3328]"
                            ...
                            <div className="ml-auto flex items-center gap-1.5">
                                ...
                                {!!token && user?.role === 'storyteller' && (
                                    <Link
                                        to="/studio"
                                        className="hidden md:block relative px-3 py-1.5 no-underline group"
                                        style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                                    >
                                        <span className="text-sub-title tracking-[0.08em] text-[#f77c9b] dark:text-white group-hover:text-amber-500 transition-colors duration-150">
                                            STUDIO
                                        </span>
                                    </Link>
                                )}
                                {!!token && user?.role === 'super_admin' && (
                                    <Link
                                        ...
                                        style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                                    >
                                        <span className="text-normal tracking-[0.08em] text-foreground group-hover:text-amber-500 transition-colors duration-150">
                                            ADMIN
                                        </span>
                                    </Link>
                                )}
                                {!!token && user?.role === 'wanderer' && (
                                    <Link
                                        ...
                                        style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                                    >
                                        <span className="text-small tracking-[0.08em] text-foreground group-hover:text-amber-500 transition-colors duration-150">
                                            BECOME CREATOR
                                        </span>
                                    </Link>
                                )}
                                ...
                                <div className="px-5 py-4 flex flex-col gap-1">
                                    ...
                                    {!!token && (
                                        ...
                                        >
                                            ...
                                            <span className="text-sub-title text-amber-500">
                                                {wallet?.balance ?? '—'}
                                            </span>
                                        </Link>
                                    )}
