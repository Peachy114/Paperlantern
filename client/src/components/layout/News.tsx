    ...
    return (
        <div className="mb-14">
            <div className="w-full">
                ...
                >
                    <span className="text-amber-400 text-[10px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.3em] font-bebas">
                        ◆ LATER N COMIX TIMES
                    </span>
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-white/30 text-[9px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.2em] font-bebas">
                        ...
                        >
                            ...
                            <div className="flex-1 relative">
                                ...
                                <div className="relative z-10 pl-4 sm:pl-16 pr-4 sm:pr-6 py-6 sm:py-8">
                                    {/* Tag */}
                                    <div
                                        className="absolute top-3 right-3 sm:top-4 sm:right-4 px-2 sm:px-3 py-1.5 sm:py-2 rotate-[2deg] z-20 font-kalam"
                                        style={{
                                            background:
                                                pinned.tag === 'event'
                                                    ? '#86efac'
                                    ...
                                    {/* Eyebrow */}
                                    <div className="text-amber-500 mb-2 text-[10px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.25em] font-bebas">
                                        ◆ {pinned.is_pinned ? 'PINNED ANNOUNCEMENT' : 'LATEST NEWS'}
                                    </div>

                                    {/* Headline */}
                                    <h1
                                        className="text-foreground leading-none mb-3 sm:mb-4 pr-20 sm:pr-0 font-bebas"
                                        style={{
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 pt-3 sm:pt-4 border-t border-foreground/10">
                                        <div
                                            className="px-2 py-1 bg-[#1a1a1a] dark:bg-foreground/90 text-white dark:text-background shrink-0 font-bebas"
                                            style={{
                                                fontSize: '10px',
                                                letterSpacing: '0.2em',
                                            }}
                                        ...
                                        <span
                                            className="text-muted-foreground font-kalam"
                                            style={{
                ...
                <div className="flex items-center justify-between mt-3 px-1">
                    <span className="text-muted-foreground/40 text-[9px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.2em] font-bebas">
