...
const FOR_ARTISTS = [
    {
        emoji: '🖊️',
        title: 'Writers',
        text: 'Publish your novels chapter by chapter. Build readers who wait for your updates.',
    },
    {
        emoji: '🎨',
        title: 'Webtoon Artists',
        text: 'Upload your panels, grow your fanbase, and tell stories only you can tell.',
    },
    {
        emoji: '🌏',
        title: 'Everyone',
        text: 'Any storyteller hobbyist or pro who has something to say.',
    },
]
            ...
            <div className="max-w-4xl mx-auto px-4 py-10 sm:py-16 text-left">
                ...
                >
                    ...
                    <div className="relative z-20 flex flex-col items-center justify-center text-center px-6 py-14 sm:py-16">
                        ...
                        >
                            A place built by creators, for creators. We believe every artist
                            deserves a stage whether you draw webtoons at 2am or write novels on
                            your lunch break.
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative sm:pl-16 p-5 sm:p-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Noto Serif', serif" }}
                        >
                            Later N Comix started as a side project by <strong>devOrbit</strong> — a
                            small team of developers and artists who kept asking the same question:
                        </p>
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Noto Serif', serif" }}
                        >
                            So we built the answer. A platform where webtoon artists, novel writers,
                            and storytellers of all kinds can publish freely, build an audience, and
                            connect with readers who genuinely care.
                        </p>
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Noto Serif', serif" }}
                        >
                            No gatekeeping. No algorithms burying your work. Just your story, your
                            way. 🏮
                        </p>
                    </div>
                </motion.div>
