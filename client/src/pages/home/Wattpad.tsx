...
function GenreSidebar({
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 pointer-events-none opacity-15 dark:opacity-[0.06]"
        style={{
      ...
      <div className="relative z-10 flex flex-col gap-0.5 p-2 pl-3">
        <button
          ...
          style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '13px', letterSpacing: '0.1em', boxShadow: !currentGenre ? '2px 2px 0 var(--foreground)' : 'none' }}
        >
          <span>ALL</span>
        ...
        {GENRES.map((g) => {
          ...
          return (
            <button
              ...
              style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '12px', letterSpacing: '0.08em', boxShadow: active ? '2px 2px 0 var(--foreground)' : 'none' }}
            >
      ...
      <div className="sm:hidden relative z-10 px-3 pb-3">
        <div
          ...
          style={{ fontFamily: "'Bebas Neue', sans-serif" }}
        >
          {comicsCount > 0 ? `${comicsCount} ${label}` : 'NO RESULTS'}
        </div>
      </div>
    </div>
  )
...
export default function WattpadIndex() {
  ...
  const sidebarProps = { currentGenre, setGenre, clearFilters, comicsCount: comics.length, label: 'NOVELS' }
          ...
          {comics.length === 0 ? (
            <div className="flex flex-col items-center justify-center min-h-[40vh] gap-3">
              ...
              >
                ...
                <p className="text-foreground/80 dark:text-white/60 tracking-[0.12em]" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '20px' }}>
                  NO NOVELS FOUND
                </p>
                <p className="text-muted-foreground/60 text-xs tracking-widest mt-1" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
