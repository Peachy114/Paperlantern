    ...
    <>
      ...
      <div className="relative min-h-[82vh] flex flex-col items-center justify-center overflow-hidden bg-[#fffdf5] dark:bg-[#1a1712] px-4">
        ...
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(circle, rgba(0,0,0,0.065) 1.2px, transparent 1.2px)',
        ...
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(circle, rgba(232,168,56,0.11) 1.2px, transparent 1.2px)',
            backgroundSize: '9px 9px',
          }}
        />
        ...
        />
        <div
          className="absolute bottom-10 right-4 sm:right-12 w-16 h-20 border-[2.5px] border-foreground/15 dark:border-foreground/8 rotate-[3deg] pointer-events-none"
        />
        <div
          className="absolute top-16 right-8 sm:right-24 w-10 h-14 border-2 border-amber-400/30 rotate-[6deg] pointer-events-none"
        />
      </div>
    </>
  )
