...
import { useAdminModerationShow } from '@/hooks/useAdminModerationShow'
          ...
          <div className="flex-1 border-[2.5px] border-[#1a1a1a] bg-[#fffdf5] dark:bg-[#1c1a17]" style={{ boxShadow: '4px 4px 0 #1a1a1a' }}>
            ...
            <div className="bg-[#1a1a1a] px-4 sm:px-6 py-4">
              <h1 className="text-red-400 leading-none" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(20px, 5vw, 32px)', letterSpacing: '0.04em' }}>
                {chapter.work.title} — Ch.{chapter.order}
              </h1>
            ...
            <div className="px-4 sm:px-6 py-4 border-b-[2px] border-[#1a1a1a] flex items-center justify-between flex-wrap gap-3">
              ...
              <div className="text-[#1a1a1a]/30 text-[10px]" style={{ fontFamily: "'Kalam', cursive" }}>
                submitted {new Date(chapter.created_at).toLocaleDateString()}
              </div>
            </div>
            ...
            <div className="px-4 sm:px-6 py-6 border-b-[2px] border-[#1a1a1a]">
                  ...
                  {chapter.images
                    ...
                    .map(img => (
                      <img
                        ...
                        className="w-full max-w-xl mx-auto border border-black/10"
                      />
                    ))
                  }
                </div>
              ...
              {chapter.content && (
                <div
                  className="text-[#1a1a1a] dark:text-foreground text-[14px] leading-relaxed max-w-2xl"
              ...
              {!chapter.images.length && !chapter.content && (
            ...
            {chapter.moderation_status === 'pending_review' && (
              <div className="px-4 sm:px-6 py-4">
                ...
                {!showViolateForm ? (
                  ...
                  <div
                    className="border-[2px] border-red-300 bg-red-50 dark:bg-red-950/20 p-4"
                  >
            ...
            {chapter.moderation_status !== 'pending_review' && (
              <div
                ...
                style={{ background: chapter.moderation_status === 'approved' ? 'rgba(134,239,172,0.2)' : 'rgba(252,165,165,0.2)' }}
              >
                <span
                  className="text-[13px]"
                  style={{ fontFamily: "'Kalam', cursive", color: chapter.moderation_status === 'approved' ? '#16a34a' : '#dc2626' }}
                >
                  {chapter.moderation_status === 'approved' ? '✓ This chapter has been approved.' : '✕ This chapter was marked as a violation.'}
                </span>
              </div>
            )}
