...
function UserRow({ user, index, actionLoading, banUser, unbanUser, setConfirmDelete }: {
  user: any
  index: number
  actionLoading: any
  ...
  return (
    ...
    >
      ...
      <div className="w-9 h-9 sm:w-11 sm:h-11 shrink-0 bg-[#1a1a1a] border border-black/10 flex items-center justify-center">
        <span className="text-amber-400 text-[14px]" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
      ...
      <div className="flex-1 min-w-0 text-start">
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {user.is_banned && (
            <span className="text-[9px] px-1.5 py-0.5 bg-red-100 text-red-700" style={{ fontFamily: "'Kalam', cursive" }}>
              BANNED
            </span>
          )}
  ...
  return (
    <div className="bg-[#1a1a1a] dark:bg-[#2a2825] px-3 sm:pl-14 sm:pr-5 py-3 flex items-center justify-between border-b-[2px] border-[#1a1a1a]">
      ...
      <div
        ...
        style={{ background: '#fca5a5', fontFamily: "'Kalam', cursive", color: '#1a1a1a', boxShadow: '1px 2px 4px rgba(0,0,0,0.25)' }}
      >
        {tag ?? `${count} total`}
      </div>
    </div>
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-6 sm:py-10">
        <div className="flex gap-0 mb-6">
          ...
          >
            ...
            {/* ── Admins Section ── */}
            <SectionHeader label="ADMINS" count={admins.length} tag={`${admins.length} admin${admins.length !== 1 ? 's' : ''}`} />
            <div className="divide-y divide-blue-200/30 dark:divide-white/10 relative">
              ...
              {admins.length === 0 ? (
                <div className="px-3 sm:pl-14 py-4 text-[11px] text-[#1a1a1a]/30 dark:text-foreground/30" style={{ fontFamily: "'Kalam', cursive" }}>
                  No admins found.
                </div>
              ) : admins.map((user, i) => (
                <UserRow
      ...
      {confirmDelete !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          ...
          >
            <p className="text-[16px] tracking-[0.08em] text-foreground mb-2" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>DELETE USER?</p>
