        ...
        <div className="flex gap-0 mb-6">
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 divide-x-[2px] divide-y-[2px] sm:divide-y-0 divide-[#1a1a1a] border-b-[2px] border-[#1a1a1a]">
              {[
                { val: stats?.total_users,    lbl: 'Total Users',    sticky: 'growing!',     color: '#ffc6a6', rotate: '2deg'    },
                { val: stats?.total_works,    lbl: 'Total Works',    sticky: 'impressive!',  color: '#ffbacf', rotate: '-1.5deg' },
                { val: stats?.total_chapters, lbl: 'Total Chapters', sticky: 'keep going!',  color: '#86efac', rotate: '1.5deg'  },
                { val: stats?.banned_users,   lbl: 'Banned Users',   sticky: 'be fair.',     color: '#fca5a5', rotate: '-1deg'   },
              ...
              {[
                ...
                >
                  <div
                    ...
                    style={{ background: color, fontFamily: "'Kalam', cursive", color: '#1a1a1a', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)', transform: `rotate(${rotate})` }}
                  >
                    {note}
                  </div>
                  <div
