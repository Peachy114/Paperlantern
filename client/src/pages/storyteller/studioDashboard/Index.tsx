...
import CardStickyNotes from '@/pages/storyteller/studioDashboard/CardStickyNotes';
        ...
        <div className="flex gap-0 mb-6">
          ...
          >
            ...
            <div className="grid grid-cols-3 divide-x-[2px] divide-[#000000] border-b-[2px] border-[#1a1a1a] overflow-visible">
              {[
                { val: works.length,                lbl: 'Works',    sticky: 'you can do it!',  color: '#ffc6a6', rotate: '2deg'    },
                { val: totalChapters,               lbl: 'Chapters', sticky: 'keep writing!',   color: '#ffbacf', rotate: '-1.5deg' },
                { val: totalViews.toLocaleString(), lbl: 'Views',    sticky: 'rooting for you', color: '#86efac', rotate: '1.5deg'  },
                ...
                <div key={lbl} className="relative px-2 sm:px-5 pt-8 pb-4 sm:pt-9 sm:pb-5 bg-[#fff9f5] dark:bg-[#1c1a17]">
                  ...
                  <div
                    className="text-[#1a1a1a] dark:text-foreground leading-none"
                    style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(20px, 5vw, 32px)' }}
                  >
                    {val}
                  </div>
                  <div
            ...
            {works.length === 0 ? (
              ...
              <div className="divide-y divide-blue-200/30 dark:divide-white/10 relative">
                ...
                {works.map((work, i) => {
                  const badge = STATUS_BADGE[work.status] ?? { label: work.status, className: 'bg-gray-100 text-gray-600' }
                  return (
                    <div
                      key={work.id}
                    ...
                    >
                      ...
                      <div className="w-10 h-14 sm:w-14 sm:h-20 flex-shrink-0 bg-[#d4cfc2] border border-black/10 overflow-hidden flex items-center justify-center text-black/20">
                        {work.cover
                          ? <img src={storageUrl(work.cover)!} alt={work.title} className="w-full h-full object-cover" />
                      ...
                      <div className="flex-1 min-w-0 text-start">
                        ...
                        <div className="flex items-center gap-1 sm:gap-1.5 mt-1 flex-wrap">
                          ...
                          <span
                            ...
                            style={{ fontFamily: "'Kalam', cursive", boxShadow: '1px 1px 2px rgba(0,0,0,0.08)' }}
                          >
                            {badge.label}
                          </span>
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2 mt-1 sm:mt-1.5 flex-wrap">
                          ...
                          <span className="hidden sm:inline text-[#1a1a1a]/20 text-xsmall">·</span>
                          <span className="hidden sm:inline text-[#1a1a1a]/40 dark:text-foreground/40 text-xsmall" style={{ fontFamily: "'Noto Serif', serif" }}>
                      ...
                      <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0">
                        <button
                          onClick={() => navigate(`/studio/works/${work.id}/chapters`)}
                        ...
                        >
                          <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                            <rect x="1" y="1" width="11" height="2" rx="0.5" fill="currentColor"/>
                            <rect x="1" y="5.5" width="8" height="2" rx="0.5" fill="currentColor"/>
                            <rect x="1" y="10" width="5" height="2" rx="0.5" fill="currentColor"/>
                          </svg>
                        </button>
                        <button
                          onClick={() => navigate(`/studio/works/${work.id}/edit`)}
                          className="sm:hidden border-[2px] border-[#1a1a1a] dark:border-foreground/70 text-[#1a1a1a] dark:text-foreground hover:bg-[#1a1a1a] hover:text-white dark:hover:bg-foreground dark:hover:text-background transition-colors duration-100 w-8 h-8 flex items-center justify-center cursor-pointer"
                          style={{ boxShadow: '1.5px 1.5px 0 #1a1a1a' }}
                          title="Edit"
                        >
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="bg-[#1a1a1a] px-5 py-4">
              <h2 className="text-white leading-none tracking-[0.04em]" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '22px' }}>
                NEW WORK
              </h2>
