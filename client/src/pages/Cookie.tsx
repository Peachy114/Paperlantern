...
const SECTIONS = [
  {
    ...
    items: [
      { title: 'Definition', text: 'Cookies are small text files stored on your device when you visit a website. They help the site remember you and your preferences.', warn: false },
      { title: 'They Are Safe', text: 'Cookies cannot run code or carry viruses. They only store small pieces of information relevant to your experience on Paper Lantern.', warn: false },
    ],
  },
  {
    number: '02',
    ...
    quote: null,
    items: [
      { title: 'Session Cookies', text: 'Keep you logged in while you browse. Without these, you would have to log in every single page visit.', warn: false },
      { title: 'Preference Cookies', text: 'Save your dark mode setting so the site looks right every time you come back.', warn: false },
      { title: 'Reading Progress', text: 'Remember where you left off in a chapter so you can pick up right where you stopped.', warn: false },
      { title: 'Security Cookies', text: 'Help us detect unusual login activity and protect your account from unauthorized access.', warn: false },
    ],
  },
  {
    number: '03',
    ...
    items: [
      { title: 'No Ad Tracking', text: 'We do not use third-party advertising cookies. Your browsing habits are not tracked for ad targeting.', warn: false },
      { title: "We Don't Sell Data", text: 'Your data is never sold to advertisers or third parties. What happens on Paper Lantern stays on Paper Lantern.', warn: false },
      { title: 'No Cross-Site Tracking', text: 'We do not track you across other websites. Our cookies only work on paperlantern.app.', warn: false },
    ],
  },
  {
    number: '04',
    ...
    quote: null,
    items: [
      { title: 'Browser Settings', text: "You can control or delete cookies through your browser settings at any time. Check your browser's help docs for instructions.", warn: false },
      { title: 'Disabling Cookies', text: 'Disabling cookies may affect your experience. Features like staying logged in or dark mode may stop working correctly.', warn: true },
      { title: 'Questions', text: 'If you have any questions about how we use cookies, reach us at privacy@paperlantern.app', warn: false },
    ],
  },
]
            ...
            <div className="px-3 sm:px-5 py-6 flex justify-center bg-[#faf8ee] dark:bg-[#191713] border-t border-black/[0.06] dark:border-white/[0.06]">
              ...
              >
                ...
                <p className="text-[#1a1a1a]/80 text-[12.5px] sm:text-[13.5px] leading-relaxed">
                  No ads, no tracking, no nonsense. We only use cookies that make Paper Lantern work properly for you. Your data stays yours. 🍪
                </p>
                <p
