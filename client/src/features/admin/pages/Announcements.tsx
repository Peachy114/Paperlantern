        ...
        <>
            ...
            >
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h1 className="text-[28px] tracking-[0.08em] text-foreground">
                            ◆ ANNOUNCEMENTS
                        </h1>
                                ...
                                <div className="flex items-start gap-4 p-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex flex-wrap items-center gap-2 mb-1">
                                            {a.is_pinned && (
                                                <span className="text-[10px] tracking-[0.15em] text-amber-500">
                                                    📌 PINNED
                                                </span>
                                            )}
                                            <span
                                                className={`text-[10px] tracking-[0.12em] px-2 py-0.5 ${TAG_COLORS[a.tag]}`}
                                            >
                                                {a.tag.toUpperCase()}
                                            </span>
                                            <span
                                        ...
                                        <p className="text-[12px] text-muted-foreground font-sans mt-1 line-clamp-2 leading-relaxed">
                                            {a.content}
                                        </p>
                                    </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    ...
                    >
                        ...
                        <div className="p-5 flex flex-col gap-4 font-sans">
                            ...
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                                <div>
                                    ...
                                    <select
                                        value={form.tag}
                                        onChange={(e) =>
                                            setForm((f) => ({ ...f, tag: e.target.value as any }))
                                        }
                                        className="w-full border-2 border-foreground bg-transparent px-3 py-2 text-[13px] text-foreground outline-none focus:border-amber-500"
                                    >
                            ...
                            <div>
                                ...
                                {imagePreview && (
                                    <img
                                        src={imagePreview}
                                        alt="preview"
                                        className="w-full h-32 object-cover border-2 border-foreground mb-2"
                                    />
                                )}
                                <input
                                    type="file"
                            ...
                            {error && <p className="text-[#F09595] text-[12px]">{error}</p>}
