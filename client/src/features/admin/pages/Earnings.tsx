import { useAdminEarnings } from '@/features/admin/hooks/useAdminEarnings'
                ...
                <div className="flex gap-0 mb-6">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 divide-x-[2px] divide-y-[2px] sm:divide-y-0 divide-[#1a1a1a] border-b-[2px] border-[#1a1a1a]">
                            {[
                                {
                                    val: v(earnings?.total_credits_spent),
                                    lbl: 'Credits Sold',
                                    sticky: 'total volume!',
                                    color: '#ffc6a6',
                                    rotate: '2deg',
                                ...
                                {
                                    val: v(earnings?.total_transactions),
                                    lbl: 'Transactions',
                                    sticky: 'chapters read!',
                                    color: '#fef08a',
                                    rotate: '-1.5deg',
                                },
                                {
                                    val: v(earnings?.pending_withdrawals_count),
                                    lbl: 'Pending Payouts',
                                    sticky: 'process soon!',
                                    color: '#ffbacf',
                                    rotate: '1.5deg',
                                ...
                                {
                                    val: p(earnings?.pending_withdrawals_php),
                                    lbl: 'Pending PHP',
                                    sticky: 'to be paid out',
                                    color: '#fca5a5',
                                    rotate: '-1deg',
                                },
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 divide-y-[2px] sm:divide-y-0 sm:divide-x-[2px] divide-[#1a1a1a] border-b-[2px] border-[#1a1a1a]">
                            ...
                            <div className="relative px-4 sm:px-6 pt-8 pb-5 bg-[#fffdf5] dark:bg-[#1c1a17]">
                                ...
                                <div
                                    className="text-[#1a1a1a]/40 dark:text-foreground/40 text-[10px] tracking-[0.18em] mb-2"
                                    style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                                >
                                    LATER N COMIX (20%)
                                </div>
                                <div
                                    className="text-[#1a1a1a] dark:text-foreground leading-none mb-1"
                                    style={{
                                        fontFamily: "'Bebas Neue', sans-serif",
                                ...
                                <div
                                    className="text-[#1a1a1a]/40 dark:text-foreground/40 text-[11px]"
                                    style={{ fontFamily: "'Kalam', cursive" }}
                                >
