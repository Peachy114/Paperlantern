import { useAdminWithdrawals } from '@/features/admin/hooks/useAdminWithdrawals'
            ...
            <div className="flex gap-0 mb-6">
                ...
                >
                    ...
                    <div className="hidden sm:grid grid-cols-[1fr_100px_140px_120px_100px] gap-3 px-5 py-2 bg-[#f5f3ea] dark:bg-[#18160f] border-b border-[#1a1a1a]/10">
                        {['Storyteller', 'Amount', 'Method / Details', 'Status', 'Actions'].map(
                            (h) => (
                                <span
                                    key={h}
                    ...
                    {isLoading ? (
                        <div
                            className="px-5 py-12 text-center text-[#1a1a1a]/40 dark:text-foreground/40"
                            style={{ fontFamily: "'Kalam', cursive" }}
                        >
                            Loading...
                        </div>
                            ...
                            {withdrawals.map((w, i) => (
                                ...
                                >
                                    ...
                                    <div className="min-w-0">
                                        <div
                                            className="text-[#1a1a1a] dark:text-foreground text-[12px] sm:text-normal truncate"
                                            style={{
                                                fontFamily: "'Bebas Neue', sans-serif",
                                        ...
                                        <div
                                            className="text-[#1a1a1a]/40 dark:text-foreground/40 text-[10px] truncate"
                                            style={{ fontFamily: "'Kalam', cursive" }}
                                        >
                                            {w.user.email}
                                        </div>
                                    ...
                                    <div className="flex sm:block items-center gap-2">
                                        <span
                                            className="text-[#1a1a1a] dark:text-foreground text-[14px] sm:text-normal"
                                            style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                                        >
                                    ...
                                    <div className="min-w-0">
                                        <div
                                            className="text-[#1a1a1a]/60 dark:text-foreground/60 text-[11px]"
                                            style={{
                                                fontFamily: "'Bebas Neue', sans-serif",
                                    ...
                                    <div>
                                        ...
                                        {w.admin_notes && (
                                            <div
                                                className="text-[#1a1a1a]/30 dark:text-foreground/30 text-[9px] mt-1 truncate"
                                                style={{ fontFamily: "'Kalam', cursive" }}
                                            >
                                                {w.admin_notes}
                                            </div>
                                    ...
                                    <div className="flex flex-wrap gap-1">
                                        ...
                                        {(w.status === 'rejected' || w.status === 'paid') && (
                                            <span
                                                className="text-[#1a1a1a]/20 dark:text-foreground/20 text-[10px]"
                                                style={{ fontFamily: "'Kalam', cursive" }}
                                            >
                                                done
                                            </span>
                    ...
                    >
                        <div className="bg-[#1a1a1a] px-5 py-4">
                            ...
                            <p
                                ...
                                style={{ fontFamily: "'Kalam', cursive" }}
                            >
                                {modal.withdrawal.user.name} — ₱
                                {Number(modal.withdrawal.amount_php).toFixed(2)} via{' '}
                                {METHOD_LABEL[modal.withdrawal.payout_method]}
                            </p>
                        </div>
