                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 divide-y-[2px] sm:divide-y-0 sm:divide-x-[2px] divide-[#1a1a1a] border-b-[2px] border-[#1a1a1a]">
                            {[
                                ...
                                {
                                    label: 'PAGE CUSTOMIZE',
                                    desc: 'edit homepage, arts, and commission page widgets',
                                    note: 'builder!',
                                    color: '#a5f3fc',
                                    rotate: '1deg',
                                ...
                                },
                                {
                                    ...
                                    desc: 'approve, reject, or suspend commission artist access',
                                    note: 'review artists',
                                    color: '#c4b5fd',
                                    rotate: '1deg',
                                    route: '/admin/commission-applications',
                                },
                                {
                                    label: 'MESSAGES',
                                    desc: 'open commission conversations as a user',
                                    note: 'wanderer view',
                                    color: '#bfdbfe',
                                    rotate: '-1deg',
                                    route: '/messages',
                                ...
                                {
                                    label: 'TOP UP SETTINGS',
                                    desc: 'create, edit, and schedule credit top-up packages',
                                    note: 'credits!',
                                    color: '#fed7aa',
                                    rotate: '-1deg',
                                    route: '/admin/top-up-settings',
                                },
                                {
                                    label: 'LABELING',
                                    desc: 'manage genres, searchable labels, and commission types',
                                    note: 'taxonomy',
                                    color: '#bbf7d0',
                                    rotate: '1deg',
                                    route: '/admin/labeling',
                                },
                                {
                                ...
                                {
                                    label: 'NOBLE ROYALTY',
                                    desc: 'manage default stickers, profile borders, and super-like rewards',
                                    note: 'premium assets',
                                    color: '#fcd34d',
                                    rotate: '-1deg',
                                    route: '/admin/noble-royalty',
                                },
                                {
                                    label: 'SUBSCRIPTIONS',
                                    desc: 'edit Noble Starter, Noble Plus, Royal Atelier, and promos',
                                    note: 'plans',
                                    color: '#ddd6fe',
                                    rotate: '1deg',
                                    route: '/admin/noble-royalty?tab=subscriptions',
                                },
                                {
                                    label: 'ANNOUNCEMENTS',
