...
import { useAdminModerationShow } from '@/features/admin/hooks/useAdminModerationShow'
                    ...
                    >
                        ...
                        <div className="px-4 sm:px-6 py-6 border-b-[2px] border-[#1a1a1a]">
                            ...
                            {!chapter.images.length && !chapter.content && (
                                <div
                                    className="text-[#1a1a1a]/30 text-[12px]"
                                    style={{ fontFamily: "'Kalam', cursive" }}
                                >
                            ...
                            >
                                ...
                                >
                                    {chapter.moderation_status === 'approved'
                                        ...
                                        : '✕ This chapter was marked as a violation.'}
                                </span>
                            </div>
                        )}
