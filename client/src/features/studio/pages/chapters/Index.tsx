...
//                                 >
//                                     {work?.type === 'webtoon' ? '◆ Webtoon' : '◆ Novel'} · manage
//                                     chapters
//                                 </p>
//                             </div>
...
//                                 <div
//                                     key={lbl}
//                                     className="relative px-2 sm:px-5 pt-8 pb-4 sm:pt-9 sm:pb-5 bg-[#fffdf5] dark:bg-[#1c1a17]"
//                                 >
...
//                                     <button
//                                         onClick={() =>
//                                             navigate(`/studio/works/${workId}/chapters/create`)
//                                         }
...
//                                                     onClick={() =>
//                                                         navigate(
//                                                             `/studio/works/${workId}/chapters/${chapter.id}/show`
//                                                         )
//                                                     }
...
//                                                     >
//                                                         <path
//                                                             d="M1 6.5C1 6.5 3 2.5 6.5 2.5C10 2.5 12 6.5 12 6.5C12 6.5 10 10.5 6.5 10.5C3 10.5 1 6.5 1 6.5Z"
//                                                             stroke="currentColor"
//                                                             strokeWidth="1.4"
...
//                                                     onClick={() =>
//                                                         navigate(
//                                                             `/studio/works/${workId}/chapters/${chapter.id}/edit`
//                                                         )
//                                                     }
//                                                     className="sm:hidden border-[2px] border-[#1a1a1a] dark:border-foreground/70 text-[#1a1a1a] dark:text-foreground hover:bg-[#1a1a1a] hover:text-white dark:hover:bg-foreground dark:hover:text-background transition-colors duration-100 w-8 h-8 flex items-center justify-center cursor-pointer"
//                                                     style={{ boxShadow: '1.5px 1.5px 0 #1a1a1a' }}
...
export default function ChapterIndex() {
    ...
    const pendingChapter = chapters.find((c) => c.id === pendingDeleteId) ?? null
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0 text-start">
                                                ...
                                                <div className="flex items-center gap-1 sm:gap-1.5 mt-1 flex-wrap">
                                                    ...
                                                    {chapter.is_locked && (
                                                        <span
                                                            className="inline-block px-1.5 py-0.5 text-[10px] sm:text-xsmall -rotate-[1deg] whitespace-nowrap"
                                                            style={{
                                                                background: '#fca5a5',
                                                                fontFamily: "'Kalam', cursive",
                                                                color: '#7f1d1d',
                                            ...
                                            <div className="flex items-center gap-1 shrink-0 mt-0.5">
                                                ...
                                                <button
                                                    onClick={() => setPendingDeleteId(chapter.id)}
                                                    className="sm:hidden border-[2px] border-red-300 dark:border-red-800 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 transition-colors duration-100 w-8 h-8 flex items-center justify-center cursor-pointer"
                                                    title="Delete"
                                                >
                                                    <svg
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            {pendingChapter
                                ? `"${pendingChapter.title}" will be permanently deleted. This action cannot be undone.`
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            ...
                            disabled={deleting}
                            className="bg-red-500 text-white hover:bg-red-600 focus-visible:ring-red-300"
                        >
