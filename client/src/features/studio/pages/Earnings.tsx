                    ...
                    >
                        ...
                        <div className="border-b-[2.5px] border-[#000000] px-3 sm:px-5 py-3 sm:py-5 flex items-center justify-between gap-3 bg-[#fffdf5] dark:bg-[#1c1717]">
                            ...
                            <button
                                ...
                                disabled={
                                    ...
                                    earnings?.latest_withdrawal?.status === 'pending'
                                }
                            ...
                            {[
                                {
                                    val: earningsLoading
                                        ? '—'
                                        : `₱${Number(earnings?.balance_php ?? 0).toFixed(2)}`,
                                    lbl: 'PHP Balance',
                                ...
                                },
                                {
                                    val: earningsLoading
                                        ? '—'
                                        : (earnings?.balance_credits ?? 0).toLocaleString(),
                                    lbl: 'Credits Earned',
                                    sticky: 'keep it up!',
                                    color: '#ffc6a6',
                                    rotate: '-1.5deg',
                                },
                                {
                                    val: earningsLoading
                                        ? '—'
                                        : `₱${Number(earnings?.min_withdrawal ?? 200).toFixed(0)}`,
                                    lbl: 'Min. Withdrawal',
                                    sticky: earnings?.can_withdraw
                                        ? 'ready to cash out!'
                                        : 'almost there!',
                        ...
                        <div className="px-3 sm:px-5 py-2.5 bg-amber-50 dark:bg-amber-950/20 border-b-[2px] border-[#1a1a1a] flex items-center gap-2">
                            <span
                                ...
                                style={{ fontFamily: "'Kalam', cursive" }}
                            >
                                💡 You earn <strong>80%</strong> of every credit spent on your
                                chapters. Later N Comix keeps 20%.
                            </span>
                        </div>
                        ...
                        {earnings?.latest_withdrawal && (
                            <div
                                ...
                                style={{
                                    background:
                                        STATUS_NOTE[earnings.latest_withdrawal.status].bg + '40',
                                }}
                            >
                                <span
                                ...
                                >
                                    💸 Your ₱
                                    {Number(earnings.latest_withdrawal.amount_php).toFixed(2)}{' '}
                                    withdrawal {STATUS_NOTE[earnings.latest_withdrawal.status].text}
                                    .
                    ...
                    >
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <div>
                                ...
                                />
                                <p
                                    className="text-[10px] text-[#1a1a1a]/40 mt-1"
                                    style={{ fontFamily: "'Kalam', cursive" }}
                                >
                            ...
                            <p
                                ...
                                style={{ fontFamily: "'Kalam', cursive" }}
                            >
                                Processing takes 3–5 business days. You'll be notified once
                                approved.
                            </p>
