            ...
            <div className="max-w-2xl mx-auto px-3 sm:px-4 py-6 sm:py-10">
                ...
                >
                    ...
                    <div className="relative z-10 px-5 sm:px-6 py-6">
                        ...
                        >
                            <span className="text-[12px] tracking-[0.1em] text-[#1a1a1a]/60 dark:text-foreground/60">
                                YOUR BALANCE
                            </span>
                                ...
                                >
                                    ...
                                    <div
                                        className={`text-[11px] mb-3 ${
                                            style.dark
                                                ? 'text-[#fffdf5]/50'
                                                : 'text-[#1a1a1a]/50 dark:text-foreground/50'
                                        }`}
                                    >
                                        credits
                                    </div>
